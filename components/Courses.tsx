...
export default function Courses() {
  const courses = [
    {
      icon: <School size={26} className="text-emerald-600 group-hover:text-white transition-colors duration-300" />,
      title: "Class 1 - 5",
    ...
    {
      icon: <GraduationCap size={26} className="text-purple-600 group-hover:text-white transition-colors duration-300" />,
      title: "Class 9",
    ...
    {
      icon: <Award size={26} className="text-amber-600 group-hover:text-white transition-colors duration-300" />,
      title: "Class 10",
    ...
    {
      icon: <Atom size={26} className="text-cyan-600 group-hover:text-white transition-colors duration-300" />,
      title: "Class 11",
    ...
    {
      icon: <Trophy size={26} className="text-rose-600 group-hover:text-white transition-colors duration-300" />,
      title: "Class 12",
    ...
    <section id="courses" className="relative py-5 md:py-5 overflow-hidden bg-slate-50 font-sans">
      ...
      <div className="relative max-w-7xl mx-auto px-5 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-indigo-50 text-indigo-950 text-xs font-black uppercase tracking-widest border border-indigo-100 shadow-sm">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {courses.map((course, index) => (
            <div
              key={index}
              className="group bg-white border-2 border-slate-200/70 rounded-[28px] p-6 lg:p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-2xl hover:border-slate-300 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between relative overflow-hidden"
            >
              <div>
                {/* Dynamic Icon Box */}
                ...
                <div className="mt-6 space-y-1.5">
                  <h3 className="text-xl font-black text-slate-950 tracking-tight group-hover:text-blue-950 transition-colors">
                    {course.title}
                  </h3>
