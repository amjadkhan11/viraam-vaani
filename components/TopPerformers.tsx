...
export default function TopPerformers() {
  ...
  return (
    <section id="toppers" className="relative py-6 md:py-8 overflow-hidden bg-slate-50 font-sans">
      ...
      <div className="relative max-w-7xl mx-auto px-5 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-2">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white text-slate-900 text-[10px] font-black uppercase tracking-widest border border-slate-200 shadow-sm">
            <Trophy size={11} className="text-blue-600 animate-pulse" />
            Wall of Fame
          </span>

          <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
            Our Top <span className="bg-gradient-to-r from-blue-700 to-blue-900 bg-clip-text text-transparent">Performers</span>
          </h2>
        </div>
          ...
          {orderedToppers.map((student) => (
            <div
              ...
              className={`group relative bg-white border-2 rounded-[32px] p-5 lg:p-6 transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md
                ${student.isFeatured
                  ? "border-blue-600 md:scale-105 z-20 md:-translate-y-2 ring-4 ring-blue-600/10"
            ...
            >
              ...
              <div>
                ...
                <div className="mt-4 text-center space-y-1">
                  <h3 className="text-lg font-black text-slate-900 tracking-tight flex items-center justify-center gap-1">
                    {student.name}
                    {student.isFeatured && <Award size={15} className="text-blue-600 flex-shrink-0" />}
                  </h3>
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 text-[8px] font-black uppercase text-blue-700 bg-slate-100 px-2 py-0.5 rounded-md tracking-wider border border-slate-200">
                      <ShieldCheck size={9} />
                      {student.tag}
                    </span>
                  </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-200">
                <div className={`relative overflow-hidden text-center py-2 rounded-2xl font-black text-2xl tracking-tighter border ${
                  student.isFeatured
                    ? "bg-gradient-to-r from-blue-700 to-blue-900 text-white border-transparent shadow-sm"
