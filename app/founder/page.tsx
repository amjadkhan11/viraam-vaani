...
export default function FounderProfilePage() {
  return (
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-900 overflow-hidden font-sans py-12 lg:py-5">
      ...
      {/* Light Mesh Accent Blurs (Royal Blue & Soft Slate) */}
      <div className="absolute top-0 left-1/3 h-[400px] w-[400px] bg-blue-600/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-12 right-1/4 h-[400px] w-[400px] bg-blue-900/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 space-y-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-black text-blue-700 uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-full border border-blue-200 shadow-sm">
            👑 Leadership & Vision
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start pt-2">
          ...
          {/* LEFT COLUMN: HERO PHOTO CONTAINER */}
          <div className="lg:col-span-4 max-w-sm mx-auto lg:mx-0 relative w-full sticky top-6">
            <div className="absolute -inset-2 bg-gradient-to-r from-blue-900/10 to-blue-600/10 rounded-[2.5rem] blur-xl opacity-70" />
            ...
            <div className="relative rounded-3xl overflow-hidden border-2 border-slate-200 bg-white p-3 shadow-2xl group">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/95 backdrop-blur-md border border-slate-200 shadow-xl flex items-center justify-between">
                <div className="space-y-0.5">
                  <span className="text-[10px] font-black uppercase text-blue-700 tracking-wider block">Mentorship Core</span>
                ...
                <div className="flex gap-1.5 items-center">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#2563eb" stroke="#2563eb" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="h-1 w-20 bg-gradient-to-r from-blue-900 to-blue-600 rounded-full" />
            </div>

            {/* STATEMENT QUOTE */}
            <div className="relative bg-gradient-to-r from-blue-50 to-white border-l-4 border-blue-900 p-4 rounded-r-2xl shadow-sm">
              <span className="text-[10px] font-black tracking-widest uppercase text-blue-700 block mb-1">Core Belief System</span>
            ...
            <div className="border border-slate-200 bg-white rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden">
              <div className="absolute bottom-0 right-0 w-24 h-24 bg-blue-600/5 rounded-full blur-xl pointer-events-none" />
              
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#2563eb" stroke="#2563eb" strokeWidth="2"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
