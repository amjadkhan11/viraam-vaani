...
export default function AboutPage() {
  return (
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-900 overflow-hidden font-sans py-12 lg:py-5">
      ...
      {/* Premium Light Royal Blue & Soft Gold Mesh Gradients */}
      <div className="absolute top-0 right-1/4 h-[400px] w-[400px] bg-blue-600/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-10 left-1/4 h-[400px] w-[400px] bg-amber-500/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 space-y-12 md:space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-amber-500/30 text-amber-600 text-xs font-bold uppercase tracking-widest shadow-sm">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight leading-none text-slate-950">
            ...
            <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-amber-600 to-amber-500">
              Smart Education
            </span>
          </h1>
        ...
        {/* PREMIUM ROYAL BLUE & GOLD STATS GRID */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { icon: TrendingUp, color: "text-amber-600 bg-amber-50 border-amber-200/60", stat: "95%", label: "Success Rate" },
            { icon: Users, color: "text-blue-900 bg-blue-50 border-blue-200/60", stat: "500+", label: "Active Students" },
            { icon: BookOpen, color: "text-amber-600 bg-amber-50 border-amber-200/60", stat: "5+", label: "Years Experience" },
            { icon: Award, color: "text-blue-900 bg-blue-50 border-blue-200/60", stat: "Top Tier", label: "Local Institute" }
          ].map((item, idx) => {
            const Icon = item.icon;
            return (
              <div key={idx} className="relative group p-5 bg-white border border-slate-200/80 rounded-2xl shadow-[0_4px_16px_-4px_rgba(0,0,0,0.02)] hover:border-amber-500/50 hover:shadow-lg transition-all duration-300 text-center overflow-hidden">
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center pt-2">
          ...
          {/* LEFT: BRAND STORY (हमारी Journey) */}
          <div className="md:col-span-7 space-y-4">
            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-black text-slate-950 tracking-tight">
                हमारी Journey 🚀
              </h2>
              <div className="h-1 w-12 bg-gradient-to-r from-blue-900 to-amber-500 rounded-full" />
            </div>
            ...
            <div className="text-slate-600 font-medium text-xs md:text-sm space-y-3 leading-relaxed">
              ...
              <div className="relative bg-blue-50/50 border-l-4 border-amber-500 p-3 rounded-r-xl italic text-slate-800 font-semibold text-xs shadow-sm">
                "At Viraam Vaani, every “Viraam” (pause) becomes a new beginning — a moment to reflect, reset, and rise stronger than before."
              </div>
            </div>

            {/* FOUNDER TRIGGER LINK (NOW WITH PREMIUM MEDIA HUB BACKGROUND STYLE) */}
            <div className="pt-2">
              <Link href="/founder" className="inline-block w-full sm:w-auto">
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-600 text-white hover:from-amber-600 hover:to-yellow-500 font-bold text-xs transition-all shadow-sm group hover:scale-[1.01] active:scale-[0.99]">
          ...
          <div className="md:col-span-5 relative w-full">
            <div className="absolute -inset-1.5 bg-gradient-to-r from-blue-600/5 to-amber-500/5 rounded-3xl blur-lg opacity-60" />
            
            <div className="relative bg-white p-5 lg:p-6 rounded-2xl border border-blue-100/80 shadow-xl flex flex-col justify-between">
              <div>
                <span className="inline-flex items-center gap-1.5 text-[10px] font-black tracking-widest text-amber-600 uppercase mb-1">
                  <Star size={10} className="fill-amber-500 text-amber-500" /> Trust Factor
                </span>
              ...
              <Link href="/admission" className="block mt-6">
                <button className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-950 to-blue-900 hover:from-blue-900 hover:to-indigo-900 text-white font-bold text-xs shadow-md shadow-blue-950/10 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-blue-100 bg-gradient-to-r from-blue-50 via-white to-blue-50 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm pt-4">
          ...
          <div className="space-y-1 text-center md:text-left relative z-10 max-w-xl">
            <span className="text-[10px] font-extrabold text-blue-900 uppercase tracking-widest block">Media & Study Labs</span>
          ...
          <Link href="/media" className="shrink-0 relative z-10 w-full md:w-auto">
            <button className="w-full md:w-auto flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-600 text-white hover:from-amber-600 hover:to-yellow-500 font-bold text-xs transition-all shadow-sm group hover:scale-[1.01] active:scale-[0.99]">
